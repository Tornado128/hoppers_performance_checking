## We implemented implicit Euler method to solve Motzkus equation numerically
## Implicit methods are always stable although they are often slower in coverging compared to explicit methods
## In this function, I am trying to numerically solve Eq. (7) in Leung, Lap Yin, et al. "A proposed complete methodology to predict
# gravity flow obstruction of pharmaceutical powders in drug product manufacturing." Journal of pharmaceutical sciences 108.1 (2019): 464-475.
## The reason for picking the numerical approach is that the parameters like wall friction angle, bulk density, ... are changing in the
#vertical direction because of the increasing load
