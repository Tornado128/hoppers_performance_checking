...
def MassFlow_or_FunnelFlow(X1, X2, Z1, Z2, sigma1_active, sigma1_passive, sigmaf, N, number, ANGLE, UYS_passive_conical_outlet, sigma1_passive_conical_outlet, rhob_passive_conical_outlet, WFA_passive_conical_outlet,  PHIE_passive_conical_outlet,UYS_active_conical_outlet, sigma1_active_conical_outlet, rhob_active_conical_outlet, WFA_active_conical_outlet, PHIE_active_conical_outlet):
    ...
    if (F == 1):                ## if it is a funnel flow in passive state
        ...
        ## Eq. (2) and Eq. (3)
        H = (130 + ANGLE)/65
        sigma = rhob_passive_conical_outlet * 9.8 * X2 * 2 / H
